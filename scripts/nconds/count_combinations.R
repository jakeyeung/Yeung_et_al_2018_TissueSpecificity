...
# outdir <- paste0("/home/yeung/projects/tissue-specificity/data/nconds2/mats_test", n.tiss, "_only_", max.n, "_chunks_", chunks)
# dir.create(outdir)
start <- Sys.time()
MakeDesMatChunks(dat.gene, out.dir = "outdir", tiss.test, n.rhyth.max = max.n, w = w, sparse = TRUE, count.mode = TRUE)
