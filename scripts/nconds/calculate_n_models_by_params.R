...
MakeDesMatChunks(dat.gene, out.dir = "/home/yeung/projects/tissue-specificity/data/nconds2/mats_chunks_test", tissues = tiss.test, n.rhyth.max = length(tiss.test), w = w, sparse = TRUE, chunks = 14)
mats <- MakeRhythmicDesignMatrices(dat.gene, w, simplify = TRUE)
