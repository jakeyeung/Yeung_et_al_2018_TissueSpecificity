...
outdir <- "/home/yeung/projects/tissue-specificity/data/nconds2/mats_11_tiss_max4_chunks_of_100000"
dir.create(outdir)
start <- Sys.time()
MakeDesMatChunks(dat.gene, out.dir = outdir, tiss.test, n.rhyth.max = 4, w = w, sparse = TRUE, chunks=100000)
