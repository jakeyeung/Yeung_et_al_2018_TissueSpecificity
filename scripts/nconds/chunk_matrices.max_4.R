...
outdir <- paste0("/home/yeung/projects/tissue-specificity/data/nconds2/mats_11_tiss_max_", max.n, "_chunks_", chunks)

dir.create(outdir)
start <- Sys.time()
MakeDesMatChunks(dat.gene, out.dir = outdir, tiss.test, n.rhyth.max = max.n, w = w, sparse = TRUE, chunks=chunks)
