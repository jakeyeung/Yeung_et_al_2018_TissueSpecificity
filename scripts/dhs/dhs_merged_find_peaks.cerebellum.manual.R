...
fname <- "data/beds/merge/ucsc_names/Cerebellum.dhs.merged.bed"
outbed <- "data/beds/merge/cutoffs_manual/Cerebellum.dhs.merged.filtered.manual.bed"
...
# counts <- sample(counts, 0.1 * length(counts))
