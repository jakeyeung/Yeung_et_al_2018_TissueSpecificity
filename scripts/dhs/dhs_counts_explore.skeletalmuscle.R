...
dhs.path <- "/home/yeung/projects/tissue-specificity/data/beds/ENCODE:Seq:SkeletalMuscle/combined.bed"
...
write.table(dhs.clean.filtered, file = "data/beds/filtered_beds/encode_peaks.skeletalmuscle.bed", 
