...
if (convert.3.to.2){
  ...
  PlotLdaOut(out.cross.rhythLiverOR.3, jdim = 1, jtitle = "Discrim 1: single factors")
  PlotLdaOut(out.cross.rhythLiverOR.3, jdim = 2, jtitle = "Discrim 2: single factors")
...
#   BoxplotLdaOut(out.cross.rhythLiverOR.3, jtitle = "Cross product separation. liverOR and rhyth.")
#   PlotLdaOut(out.cross.rhythLiverOR.3, take.n = 50, from.bottom = TRUE, 
#              jtitle = paste0("Cross product loadings. LiverOR and rhyth. (from bottom). Dist:", 
#                              distfilt, "\nN FG peaks:", 
#                              length(unique(mat.fg$gene)), 
#                              "\nN BG peaks:", length(unique(mat.bgnonliver$gene))))
