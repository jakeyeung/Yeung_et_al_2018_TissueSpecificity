...
signal.cutoff.high <- 1
fg.peaks.filt <- as.character(subset(jsub, signal > signal.cutoff.high)$peak)  # do further cuts
# fg.peaks.filt <- as.character(jsub$peak)  # take all
