...
# File: ~/projects/tissue-specificity/scripts/kidney_WT_KO/nconds_downstream_analysis_g_sweep.R
# g swep analysis
...
load("/home/yeung/projects/tissue-specificity/Robjs/liver_kidney_atger_nestle/nconds_kidney_WTKO/fits.kidney_WTKO.long.filtbest.staggeredtimepts.bugfixed.Robj", v=T)
...
loadfile <- "Robjs/liver_kidney_atger_nestle/nconds_kidney_WTKO/dat.kidneyWTKO.complex.all_T.Robj"
if (file.exists(loadfile)){
  ...
  outfcomp <- "Robjs/liver_kidney_atger_nestle/nconds_kidney_WTKO/dat.kidneyWTKO.complex.all_T.bugfixed.Robj"
  if (!file.exists(outfcomp)) save(dat.complex.all_T, file = outfcomp)
  rm(dat.complexes)
}
outffreq <- "Robjs/liver_kidney_atger_nestle/nconds_kidney_WTKO/dat.freq.kidneyWTKO.bugfixed.Robj"
