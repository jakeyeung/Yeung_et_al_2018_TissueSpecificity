...
Tissues coordinate with 24h solar day to carry out function
...
\begin{center}
\includegraphics[height=0.45\textheight]{images/matrix-representation}
\end{center}
...
v.plot <- PlotComplex2(eigengene, labels = rownames(act.svd$v), omega = omega, title = paste("First component activity (eigenmotif)")) +
...
u.plot <- PlotComplex2(eigensamp, labels = rownames(act.svd$u), omega = omega, title = paste("First component activity (eigentissue)")) +
