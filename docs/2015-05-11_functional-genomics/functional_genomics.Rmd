...
\begin{center}
\includegraphics[height=0.7\textheight]{images/circadian-introduction}
\end{center}
...
\begin{center}
\includegraphics[height=0.65\textheight]{images/matrix-representation}
\end{center}
...
## Example of correlation of alternative promoter usage to tissue-restricted circadian rhythms
...
15% of 1062 (FDR 5%) tissue-restricted circadian rhythms are associated with alternative promoter usage
